...
<html>
    ...
    String nomegerente = request.getParameter("Gerente");
    ...
    String senha = request.getParameter("Senha");
        ...
        conn = DriverManager.getConnection(jdbcUrl, jdbcUser, jdbcPassword);
                ...
                st = conn.prepareStatement("UPDATE gerente SET nome_gerente=?, cpf=?, senha=?  WHERE id=?");
                st.setString(1, nomegerente);
                st.setString(2, cpf);
                ...
                response.sendRedirect("Listar_gerente.jsp?Cod=" + id_pro );
