...
<html>
    ...
    String jdbcPassword = "pedro123@";
        ...
        conecta  = DriverManager.getConnection(jdbcUrl, jdbcUser, jdbcPassword);
            ...
            st = conecta.prepareStatement("SELECT * FROM funcionario WHERE cod_empresa = " + Cod);
            ...
            out.print("<tr><th> ID </th><th> Nome Funcionario </th> <th> CPF </th><th>ID Empresa</th> <th>Exclusão</th><th>Alteração</th></tr>");      
            while(resultado.next()){
               out.print("<tr><td>" + resultado.getString("id") + "</td><td>" + resultado.getString("nome_funcionario") + "</td><td>" + resultado.getString("cpf") + "</td><td>" + resultado.getString("cod_empresa") + "</td>");
                out.print("<td> <a href=Escluir_Funcionario.jsp?id=" + resultado.getString("id") + "&Cod=" + Cod + "> Excluir </a> </td>");
               out.print("<td> <a href=Alterar_funcionario_form.jsp?id=" + resultado.getString("id") + "&Cod=" + Cod + "> Alterar </a> </td> </tr>");
            }
            out.print("</table>");
        %>
    </body>
